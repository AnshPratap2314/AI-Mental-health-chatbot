...
class ResponseEngine:
    ...
    def generate(
        ...
        # Moderate-risk conversations can still benefit from natural, mood-aware
        # language. Immediate/high-risk cases are handled before this point by
        # the deterministic safety layer. The LLM is never allowed to change
        # the safety decision.
        if signals.get("serious") and self.llm_engine is None:
